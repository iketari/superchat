...
;pug_debug_line = 14;pug_debug_filename = "components\u002Fchat\u002Fchat.tmpl.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = message.date && message.date.toTimeString().split(' ')[0]) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E";
